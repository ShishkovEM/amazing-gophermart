...
func PostOrder(w http.ResponseWriter, r *http.Request, storage *storage.Storage, secretKey []byte) {
...
func GetOrders(w http.ResponseWriter, r *http.Request, storage *storage.Storage, secretKey []byte) {
